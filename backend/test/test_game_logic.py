...
class TestTractorGameLogic(unittest.TestCase):
    ...
    def test_compare_hands_different_types(self):
        ...
        special_235 = [('2', '♥'), ('3', '♦'), ('5', '♠')]
        three_of_a_kind = [('J', '♥'), ('J', '♦'), ('J', '♣')]
        self.assertEqual([0], compare_hands([special_235, three_of_a_kind], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        self.assertEqual([1], compare_hands([three_of_a_kind, special_235], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 235 < 同花顺（因为235与非豹子比较时视为单牌）
        straight_flush = [('A', '♥'), ('K', '♥'), ('Q', '♥')]
        self.assertEqual([1], compare_hands([special_235, straight_flush], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 235 < 顺子（因为235与非豹子比较时视为单牌）
        straight = [('10', '♥'), ('J', '♦'), ('Q', '♣')]
        self.assertEqual([1], compare_hands([special_235, straight], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 235 < 金花（因为235与非豹子比较时视为单牌）
        flush = [('2', '♠'), ('5', '♠'), ('10', '♠')]
        self.assertEqual([1], compare_hands([special_235, flush], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 235 < 对子（因为235与非豹子比较时视为单牌）
        pair = [('A', '♥'), ('A', '♦'), ('5', '♣')]
        self.assertEqual([1], compare_hands([special_235, pair], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 豹子 > 同花顺
        self.assertEqual([0], compare_hands([three_of_a_kind, straight_flush], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 同花顺 > 顺子
        self.assertEqual([0], compare_hands([straight_flush, straight], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 顺子 > 金花
        self.assertEqual([0], compare_hands([straight, flush], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 金花 > 对子
        self.assertEqual([0], compare_hands([flush, pair], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 对子 > 单牌
        high_card = [('3', '♥'), ('7', '♦'), ('K', '♠')]
        self.assertEqual([0], compare_hands([pair, high_card], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
    ...
    def test_compare_hands_same_types(self):
        ...
        self.assertEqual([0], compare_hands([straight1, straight2], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 相同牌型的对子比较
        pair1 = [('A', '♥'), ('A', '♦'), ('5', '♣')]  # A对
        pair2 = [('K', '♥'), ('K', '♦'), ('10', '♣')]  # K对
        self.assertEqual([0], compare_hands([pair1, pair2], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 相同牌型的单牌比较
        high_card1 = [('A', '♥'), ('K', '♦'), ('Q', '♣')]  # A-K-Q
        high_card2 = [('K', '♥'), ('Q', '♦'), ('J', '♣')]  # K-Q-J
        self.assertEqual([0], compare_hands([high_card1, high_card2], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 完全相同的牌，谁先比谁输
        hand1 = [('A', '♥'), ('K', '♦'), ('Q', '♣')]
        hand2 = [('A', '♥'), ('K', '♦'), ('Q', '♣')]
        self.assertEqual([1], compare_hands([hand1, hand2], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
    ...
    def test_235_rule_edge_cases(self):
        ...
        self.assertEqual([0], compare_hands([special_235, three_of_a_kind_ace], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 测试相同花色的235（金花）与豹子比较
        flush_235 = [('2', '♥'), ('3', '♥'), ('5', '♥')]  # 同花235
        self.assertEqual([1], compare_hands([flush_235, three_of_a_kind_ace], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
    ...
    def test_235_as_high_card_against_non_three_of_a_kind(self):
        ...
        # 单牌
        high_card = [('3', '♠'), ('5', '♣'), ('K', '♦')]
        self.assertEqual([1], compare_hands([special_235, high_card], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
    ...
    def test_a23_smallest_straight(self):
        ...
        # A23应小于234顺子
        self.assertEqual([1], compare_hands([a23, straight_234], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
    ...
    def test_high_card_suit_comparison(self):
        ...
        self.assertEqual([0], compare_hands([hand1, hand2], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))  # 红桃 > 梅花
        self.assertEqual([1], compare_hands([hand2, hand3], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))  # 方块 > 梅花（正确，返回索引1表示第二个参数更大）
        self.assertEqual([0], compare_hands([hand3, hand4], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))  # 方块 > 黑桃
        ...
        self.assertEqual([0], compare_hands([high_card_a_heart, high_card_a_club], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))  # A的花色决定结果
        
        # A花色相同，比较K的花色
        high_card_a_same_k_heart = [('A', '♥'), ('K', '♥'), ('Q', '♠')]  # A相同，K是红桃
        high_card_a_same_k_club = [('A', '♥'), ('K', '♣'), ('Q', '♥')]   # A相同，K是梅花
        
        self.assertEqual([0], compare_hands([high_card_a_same_k_heart, high_card_a_same_k_club], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))  # K的花色决定结果
        
        # A和K花色都相同，比较Q的花色
        high_card_ak_same_q_heart = [('A', '♥'), ('K', '♥'), ('Q', '♥')]  # A和K相同，Q是红桃
        high_card_ak_same_q_club = [('A', '♥'), ('K', '♥'), ('Q', '♣')]   # A和K相同，Q是梅花
        
        self.assertEqual([0], compare_hands([high_card_ak_same_q_heart, high_card_ak_same_q_club], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))  # Q的花色决定结果
        ...
        self.assertEqual([1], compare_hands([mixed_cards1, mixed_cards2], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))  # 正确，返回索引1表示第二个参数更大
    ...
    def test_multi_hands_comparison(self):
        ...
        self.assertEqual(max_index, [0])  # 豹子大于235
    ...
    def test_multi_hands_edge_cases(self):
        ...
        self.assertEqual(max_index, [0, 1, 2])
    ...
    def test_235_with_three_of_a_kind_combinations(self):
        ...
        # 同花235应该小于所有豹子，无论235规则是否启用
        self.assertEqual([1], compare_hands([same_suit_235, three_of_a_kind_2], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        self.assertEqual([1], compare_hands([same_suit_235, three_of_a_kind_2], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=False, is_A23_as_straight=True))
        
        # 测试4: 非同花235与同花235的比较
        # 非同花235（特殊牌型）vs 同花235（金花）
        # 当启用235大于豹子规则时，由于所有手牌中没有豹子，以同花235更大
        self.assertEqual([1], compare_hands([special_235, same_suit_235], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 当禁用235大于豹子规则时，非同花235等级为1，同花235等级为3，所以同花235更大
        self.assertEqual([1], compare_hands([special_235, same_suit_235], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=False, is_A23_as_straight=True))
    ...
    def test_a23_as_straight_combinations(self):
        ...
        self.assertEqual([1], compare_hands([a23, straight_234], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        self.assertEqual([1], compare_hands([a23, straight_345], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        self.assertEqual([1], compare_hands([a23, straight_QKA], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        
        # 禁用A23作为顺子
        # A23应该被视为普通单牌，所以应该小于所有顺子
        self.assertEqual([1], compare_hands([a23, straight_234], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=False))
        self.assertEqual([1], compare_hands([a23, straight_345], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=False))
        self.assertEqual([1], compare_hands([a23, straight_QKA], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=False))
        ...
        self.assertEqual([1], compare_hands([flush_a23, flush_234], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
        self.assertEqual([1], compare_hands([flush_a23, flush_QKA], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
    ...
    def test_complex_hand_combinations(self):
        ...
        self.assertEqual([1], compare_hands([same_suit_235, same_suit_a23], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))  # 同花A23(同花顺)应大于同花235
        
        # 禁用A23作为顺子，同花A23为同花，A大于5，所以同花A23更大
        self.assertEqual([1], compare_hands([same_suit_235, same_suit_a23], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=False))  # 同花A23应大于同花235

        # 测试3: 非同花235与非同花A23的比较
        # 非同花235（等级1或7）vs 非同花A23（等级1或4）
        # 启用235大于豹子和A23作为顺子，启用A23是顺子
        self.assertEqual([1], compare_hands([different_suit_235, different_suit_a23], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))  # 非同花A23(顺子)应大于非同花235
        
        # 禁用235大于豹子但启用A23作为顺子
        self.assertEqual([1], compare_hands([different_suit_235, different_suit_a23], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=False, is_A23_as_straight=True))  # 非同花A23(顺子)应大于非同花235(单牌)

        # 启用235大于豹子但禁用A23作为顺子
        self.assertEqual([1], compare_hands([different_suit_235, different_suit_a23], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=False))  # 非同花235应大于非同花A23
        
        # 禁用235大于豹子和A23作为顺子
        # 两者都是单牌，按牌面值比较
        self.assertEqual([1], compare_hands([different_suit_235, different_suit_a23], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=False, is_A23_as_straight=False))  # 非同花A23应大于非同花235
        ...
        # 同花A23应该是最大的（同花顺）
        self.assertEqual([0], compare_hands([same_suit_a23, same_suit_235, different_suit_235, different_suit_a23], raise_compare_hand_index=0, isDiffentSuit235GreaterThanThreeOfAKind=True, is_A23_as_straight=True))
